My biggest commits weren't actually uploaded to my GitHub profile activity, so it won't go towards my stats, so here's the link to them (both numbers are excluding auto generated files): <br>
